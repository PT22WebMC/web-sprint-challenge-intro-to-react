...
React is a Javascript library. It makes everything a lot easier by alloweing us to use html inside javascript and also css.

1. Describe component state.
Component state is managed within a component. It can be defined as an object that has properties that control the behavior of the component. It contains information that may be changed in the component. 

1. Describe props.
Props is data that gets passed from component to component. 

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
A side effect is something that affects things outside of the current function that is being executed. We can use useEfect hook to manage side effects. 
